            ...
            recaptchaVerifier.current
                ...
                .then((widgetId) => {
                    ...
                    if (div_error) {
                        ...
                        signInWithPhoneNumber(firebaseAuth, phone_format, recaptchaVerifier.current)
                            .then((result) => {
                ...
                >
                    <Layout className={styleLogin.layout}>
                        ...
                        <Sider
                            ...
                            style={{
                                background:
                                    'linear-gradient(0deg, rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), radial-gradient(123.18% 99.53% at 130.47% 0%, #FD4363 0%, #2D229B 100%)',
                            }}
                            id="onboarding"
                        >
                            <MobileOBDSlider />
