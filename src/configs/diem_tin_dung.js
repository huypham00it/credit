        ...
        form_02: {
            ...
            e_wallet: {
                ...
                options: [
                    ...
                    { label: "FPT Wallet", value: "FPT Wallet" },
                    { label: "eWallet", value: "eWallet" },
                    { label: "Moca", value: "Moca" },
                    { label: "ShopeePay", value: "ShopeePay" },
                    { label: "M_Service", value: "M_Service" },
                    { label: "PayNow", value: "PayNow" },
                    { label: "E - Commerce Vietnam", value: "E - Commerce Vietnam" },
                    { label: "VTC Pay", value: "VTC Pay" },
                    { label: "Vcoin", value: "Vcoin" },
                    { label: "Appota", value: "Appota" },
                    { label: "F Pay", value: "F Pay" },
                    { label: "VNPT Pay", value: "VNPT Pay" },
                    { label: "NganLuong", value: "NganLuong" },
                    { label: "BảoKim", value: "BảoKim" },
                    { label: "123Pay", value: "123Pay" },
                    { label: "NPay", value: "NPay" },
                    { label: "VinID", value: "VinID" },
                    { label: "VTC E - wallet", value: "VTC E - wallet" },
                    { label: "PayAQ", value: "PayAQ" },
                    { label: "Baokim Wallet", value: "Baokim Wallet" },
                    { label: "TienPhong Wallet", value: "TienPhong Wallet" },
                    { label: "VietinBank Wallet", value: "VietinBank Wallet" },
                    { label: "JCB Wallet", value: "JCB Wallet" },
                    { label: "Techcombank Wallet", value: "Techcombank Wallet" },
                    { label: "VietCapital Wallet", value: "VietCapital Wallet" },
                    { label: "DongA Bank Wallet", value: "DongA Bank Wallet" },
                    { label: "Agribank Wallet", value: "Agribank Wallet" },
                    { label: "MBBank Wallet", value: "MBBank Wallet" },
                    { label: "OceanBank Wallet", value: "OceanBank Wallet" },
                    { label: "GPBank Wallet", value: "GPBank Wallet" },
                    { label: "TPBank Wallet", value: "TPBank Wallet" },
                    { label: "Sacombank Wallet", value: "Sacombank Wallet" },
                    { label: "Eximbank Wallet", value: "Eximbank Wallet" },
                ]
            }
        },
        form_03: {
