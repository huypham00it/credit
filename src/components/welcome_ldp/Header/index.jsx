...
const Header = ({ logo, navs, start, current, setCurrent }) => {
    ...
    return (
        <header ref={headerRef} className={style.header}>
            <div>
                <Logo type="light" width={screen.md ? 141 : 107.43} height={screen.md ? 42 : 32} />
                ...
                <nav>
                    ...
                    {!screen.md && (
                        <div
                            className={style.hamburger + ' ' + (active ? style.active : '')}
            ...
            {/* MENU MOBILE */}
            {!screen.md && (
                <ul className={style.menu + ' ' + (active ? style.active : '')}>
                    {navs.map((nav, i) => (
