...
export default function ProvinceQuestion({ user, setUser, prevQuestion, nextQuestion, total_steps }) {
                ...
                <Space direction="vertical">
                    ...
                    >
                        <div
                            className={
                                openSuggestions
                                    ? signupStyle.province_suggestions
                                    : signupStyle.province_suggestion_hide
                            }
                        >
