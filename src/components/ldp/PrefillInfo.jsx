...
const PrefillInfo = ({ form, handleTrackingStart, handleTrackingEnd, ...props }) => {
    const { user } = UserInfo();
    ...
    return (
        <>
            <NameInput
                ...
                ruleMsg={props.nameRuleMsg}
                addonAfter={
                    <EditOutlined
                        style={{ color: disabledStatus.name ? '' : '#594DC9' }}
                        onClick={() => setDisabledStatus({ ...disabledStatus, name: !disabledStatus.name })}
                    />
                }
            ...
            <IDInput
                ...
                ruleMsg={props.idRuleMsg}
                size="large"
                disabled={disabledStatus.id_card}
                addonAfter={
                    <EditOutlined
                        style={{ color: disabledStatus.id_card ? '' : '#594DC9' }}
                        onClick={() => setDisabledStatus({ ...disabledStatus, id_card: !disabledStatus.id_card })}
                    />
                }
            ...
            <PhoneNumberInput
                ...
                maxLength={props.phoneMaxLength}
                ruleMsg={props.phoneRuleMsg}
                name="phone"
                ...
                addonAfter={
                    <EditOutlined
                        style={{ color: disabledStatus.phone ? '' : '#594DC9' }}
                        onClick={() => setDisabledStatus({ ...disabledStatus, phone: !disabledStatus.phone })}
                    />
                }
